...
@section('page-title','Blog-Create | Women In Digital | Admin')
@push('page-css')
<!-- Form Uploads -->
        ...
        <div class="col-xl-12">
          <div class="page-title-box">
            <div class="d-flex justify-content-between align-items-center text-muted">
              <h4 class="page-title float-left"><i class="zmdi zmdi-blogger"></i> Blog {{ isset($blog) ? 'Edit' : 'Create' }}</h4>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <fieldset>
                        ...
                        <input type="file" name="thumbnail" id="thumbnail" class="dropify" data-default-file="{{ isset($blog) ? asset('uploads/blogs/'. $blog->thumbnail) : '' }}" data-max-file-size="1M" />
                      </fieldset>
                    </div>
                  </div>
                  <fieldset class="form-group">
