...
@section('page-title','Blog-List | Women In Digital | Admin')
@push('page-css')
<!-- DataTables -->
                    ...
                    <tr>
                      ...
                      <td class="d-flex">
                        <div class="avater">
                          ...
                          src="{{ $blog->thumbnail != null ? asset('uploads/blogs/'. $blog->thumbnail) : asset('assets/application-default/img/gallery.jpg') }}" alt="blog-avatar">
                        </div>
                      </td>
