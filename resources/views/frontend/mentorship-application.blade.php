...
@section('title', 'Mentorship-Application | Wome-In-Digital')
@push('meta-tag')
<meta property="og:title" content="Mentorship-Application | Wome-In-Digital" />
...
<meta property="og:url" content="{{ route('mentorship.application') }}" />
  ...
  <section class="join-team">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10">
          <div class="card">
            <h4 class="pb-3">Application For Mentorship</h4>
            <form action="{{ route('mentor.store') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" id="name" placeholder="Mentor Name" required>
                  @error('name')
                ...
                <div class="col-md-6 form-group mt-4 mt-md-0">
                  <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" id="email" placeholder="Mentor Email" required>
                  @error('email')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
              ...
              <div class="row">
                <div class="col-md-6 form-group mt-4">
                  <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" id="phone" placeholder="Mentor Phone Number" required>
                  @error('phone')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
                ...
                <div class="col-md-6 form-group mt-4">
                  <input type="text" class="form-control @error('nid') is-invalid @enderror" name="nid" value="{{ old('nid') }}" id="nid" placeholder="Mentor NID Number">
                  @error('nid')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
              ...
              <div class="row">
                <div class="col-md-6 form-group mt-4">
                  <textarea class="form-control @error('profession') is-invalid @enderror" name="profession" rows="5" placeholder="Mentor Profession & Expertise / Max-Length: 5000 char" required>{{ old('profession') }}</textarea>
                  @error('profession')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
                ...
                <div class="col-md-6 form-group mt-4">
                  <textarea class="form-control @error('bio') is-invalid @enderror" name="bio" rows="5" placeholder="Mentor Bio" required>{{ old('bio') }}</textarea>
                  @error('bio')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
